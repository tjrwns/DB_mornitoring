...
var a = [
	...
	//B2Labs - Admin;
	//{ mid : "b2labs@b2link.co.kr", cd$authority_code : 50000004, nm : { a : "BLS" }, cd$category_division : "BLS" }

	//Brand Incubation Division;
	{ mid : "bid@b2link.co.kr", cd$authority_code : 50000004, nm : { a : "BID" } }

	//Brand Sales Division;
	, { mid : "bsd@b2link.co.kr", cd$authority_code : 50000004, nm : { a : "BSD" } }

	//Shared Service Division;
	, { mid : "ssd@b2link.co.kr", cd$authority_code : 50000004, nm : { a : "SSD" } }
];
...
for( ; i<iLen; ++i ){
	var io = a[ i ];
		...
		if( !io.cd$category_division ) io.cd$category_division = "Division";
