...
{
	print( "-- [ S ] - member_basic$getSearchList():{Array}----------" );
	...
	member_basic$_getCol().find( oFind
	...
	.forEach( function( doc ){ doc.seq = ++_skip; r.push( doc ); });

	print( "-- [ E ] - member_basic$getSearchList():{Array}----------return r;" );
	return r;
}