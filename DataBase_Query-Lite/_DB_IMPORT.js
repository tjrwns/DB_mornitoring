...
var _TARGET_DB_PORT_ = {
	...
	, ONSIGHT_BATCH  : { "HOST" : "192.168.0.230", "PORT" : 57321, "DB" : "admin", "ID" : "b2link", "PASS" : "qlxnfldzmdb2017_" }
	...
	//Lite
	, "KAOLA--Lite"          : { "HOST" : "192.168.0.230", "PORT" : 55542, "DB" : "admin", "ID" : "b2link", "PASS" : "qlxnfldzmdb2017_" }
	, "TAOBAO-DAILY--Lite"   : { "HOST" : "192.168.0.230", "PORT" : 55539, "DB" : "admin", "ID" : "b2link", "PASS" : "qlxnfldzmdb2017_" }
	, "VIP--Lite"            : { "HOST" : "192.168.0.230", "PORT" : 55543, "DB" : "admin", "ID" : "b2link", "PASS" : "qlxnfldzmdb2017_" }
...
/*
DB : MicroData , CollectionName : ALL
*/

var FN1 = function( _TARGET_SITE_ ){
	...
	for(;i<iLen;++i){
		var _t = _COMMAND_TEMPLATE_;
		//var r = _t.replace("<!=COL=!>",_TARGET_FILE_LIST_[ i ].split(".")[ 1 ] )
		var r = _t.replace("<!=COL=!>", _TARGET_FILE_LIST_[ i ].split(".")[ 0 ] + "_ALL" )
			.replace("<!=HOST=!>", _TARGET_DB_PORT_[ _TARGET_SITE_ ].HOST )
			.replace("<!=FILE_NAME=!>", _DIR_PATH_ + _TARGET_FILE_LIST_[ i ])
			.replace("<!=PORT=!>", _TARGET_DB_PORT_[ _TARGET_SITE_ ].PORT )
			.replace("<!=DB=!>", "MicroData" );
		commands = commands + r + "\n";
	}
	return commands;
};
