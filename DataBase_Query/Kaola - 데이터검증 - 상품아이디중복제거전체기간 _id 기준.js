...
var a = SUtilFsReadStream.getFile( dir00 + "Kaola - 데이터검증 - 상품아이디중복제거전체기간 _id 기준 - 템플릿.json" ).toString()
console.log( a )
...
b.forEach(function(file){
	...
	var r = _a.replace( "<!=goodsList=!>", c );
	STtwUtilFsWriteStream.writeFile( dir03 + file, r );
