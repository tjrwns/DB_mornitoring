//----------------------------------------------------------------------------------------------------;
var fileNm = "js__b2link__SYS0037/b2link/__define/101_define_global.b2link.STATIC.CONFIG.js";
...
//------------------------------;
global.b2link.STATIC.CONFIG.URL.SCODE = "onsight-db-processing";//시스템 개별 정의;
global.b2link.STATIC.CONFIG.URL.SCODE = "SYS0037";//시스템 개별 정의;
global.TtwLog.timeStamp( "--------------------------------------------------[ E ] - global.b2link.STATIC.CONFIG.URL" );
global.TtwLog.timeStamp( "--------------------------------------------------[ S ] - global.b2link.STATIC.CONFIG.MongoDB" );
global.b2link.STATIC.CONFIG.MongoDB = global.b2link.STATIC.CONFIG.MongoDB || {};
//------------------------------;

global.TtwLog.timeStamp( "--------------------------------------------------[ E ] - global.b2link.STATIC.CONFIG.MongoDB" );
