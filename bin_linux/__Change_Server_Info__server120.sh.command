...
file_name__api_server_target="../HTTPServer_MongoDB/APIServer/js/b2link/url/global.b2link.url.getServerURLByServers.js.server-120";
...
#file_name__api_server_target="../HTTPServer_MongoDB/APIServer/js/b2link/url/global.b2link.url.getServerURLByServers.js.server-126";
...
file_name__http_server_target="../HTTPServer_WebPage/js/b2link/url/global.b2link.url.getServerURLByServers.js.server-120";
...
#file_name__http_server_target="../HTTPServer_WebPage/js/b2link/url/global.b2link.url.getServerURLByServers.js.server-126";
...
file_name__web_db_target="../WebPage/root/js-common/b2link/url/window.b2link.url.getServerURLByDB.js.server-120"
...
#file_name__web_db_target="../WebPage/root/js-common/b2link/url/window.b2link.url.getServerURLByDB.js.server-126"
...
file_name__web_server_target="../WebPage/root/js-common/b2link/url/window.b2link.url.getServerURLByServers.js.server-120"
...
#file_name__web_server_target="../WebPage/root/js-common/b2link/url/window.b2link.url.getServerURLByServers.js.server-126"
...
file_name__mongodb_original="../MongoDB/3.4.5_x64__Linux/Config/B2LINK/0.conf"
#file_name__mongodb_target="../MongoDB/3.4.5_x64__Linux/Config/B2LINK/0.conf.localhost"
#file_name__mongodb_target="../MongoDB/3.4.5_x64__Linux/Config/B2LINK/0.conf.server"
file_name__mongodb_target="../MongoDB/3.4.5_x64__Linux/Config/B2LINK/0.conf.server-120"
#file_name__mongodb_target="../MongoDB/3.4.5_x64__Linux/Config/B2LINK/0.conf.server-122"
#file_name__mongodb_target="../MongoDB/3.4.5_x64__Linux/Config/B2LINK/0.conf.server-123"
#file_name__mongodb_target="../MongoDB/3.4.5_x64__Linux/Config/B2LINK/0.conf.server-126"

if test -e $file_name__mongodb_original
then
{
	rm $file_name__mongodb_original
	echo "$file_name__mongodb_original 파일 제거"
	cp $file_name__mongodb_target $file_name__mongodb_original
	echo "$file_name__mongodb_target 파일 복사"
}
fi
