...
call del /s /q ..\js__b2link__SYS0037\__list.json
call del /s /q ..\js__b2link__SYS0037\__listDir.json
call del /s /q ..\js__b2link__SYS0037\__listPackage.json
...
call del /s /q ..\ui_js\SYS0037\__listPackage.json
