...
find ../js__b2link__SYS0037/ -name '__list.json' -exec rm -f {} \;
find ../js__b2link__SYS0037/ -name '__listDir.json' -exec rm -f {} \;
find ../js__b2link__SYS0037/ -name '__listPackage.json' -exec rm -f {} \;
