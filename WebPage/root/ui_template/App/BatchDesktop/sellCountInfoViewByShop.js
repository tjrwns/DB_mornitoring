...
var fancygrid0_evt_click_btn = function( grid, value ){
	...
	var FNS = {
		"List Chart" : function( grid, value ){
			...
			window.SYS0037_UI_API.fancygrid.render_sellcount_distribution_by_shop__grid.getData( grid, value, function( data ){
				...
				if( !_CTRLS.fancygrid_1 ) _CTRLS.fancygrid_1 = window.SYS0037_UI_API.fancygrid.render_sellcount_distribution_by_shop__grid( DATA );
				else
				{
					//update;
				...
				if( !_CTRLS.chart0 )
				{
					...
					window.SYS0037_UI_API.echarts.sellcount_info_by_shop_view_Async( DATA,function(chart){
						_CTRLS.chart0 = chart
					});
				}
				else
				{
					window.SYS0037_UI_API.echarts.sellcount_info_by_shop_view_Async.updateSeriesData( _CTRLS.chart0, DATA,function(chart){
						_CTRLS.chart0 = chart
					});
				}
		...
		, "Full List" : function( grid, value ){
			...
			{
				window.SYS0037_UI_API.echarts.sellcount_info_by_shop_view_Async.updateSeriesData( _CTRLS.chart1, DATA,function(chart){
					_CTRLS.chart1 = chart
				});
			}
		}
