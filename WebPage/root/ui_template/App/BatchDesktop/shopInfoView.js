...
var fancygrid0_evt_click_btn = function( grid, value ){
	...
	var FNS = {
		"List Chart" : function( grid, value ){
			...
			window.SYS0037_UI_API.fancygrid.event.click_btn_render_shop_distribution__grid( grid, value, function( data ){
				...
				if( !_CTRLS.fancygrid_1 ) _CTRLS.fancygrid_1 = window.SYS0037_UI_API.fancygrid.render_shop_distribution__grid( DATA )
				else
				{
					//update;
				...
				if( !_CTRLS.chart0 ){
					...
					window.SYS0037_UI_API.echarts.shop_info_view_Async( DATA,function(chart){
						_CTRLS.chart0 = chart
					});

					//_CTRLS.chart0 = window.SYS0037_UI_API.echarts.shop_info_view( DATA );
				}
				else
				{
					window.SYS0037_UI_API.echarts.shop_info_view_Async.updateSeriesData( _CTRLS.chart0, DATA,function(chart){
						_CTRLS.chart0 = chart
					});
					//_CTRLS.chart0 = window.SYS0037_UI_API.echarts.shop_info_view.updateSeriesData( _CTRLS.chart0, DATA )
				}
		...
		, "Full List" : function( grid, value ){
			...
			if( !_CTRLS.chart1 )
			{
				...
				//_CTRLS.chart1 = window.SYS0037_UI_API.echarts.shop_info_view( DATA );
			}
			else
			{
				window.SYS0037_UI_API.echarts.shop_info_view_Async.updateSeriesData( _CTRLS.chart1, DATA,function(chart){
					_CTRLS.chart1 = chart
				});
				//_CTRLS.chart1 = window.SYS0037_UI_API.echarts.shop_info_view.updateSeriesData( _CTRLS.chart1, DATA );
			}
