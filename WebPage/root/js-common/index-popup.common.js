...
window.__defineGetter__( "__isPopup", function(){ return true; } );
...
return el;})().onload = function(){ window.console.log( "Initialize Libraries Complete." );
	...
	window.b2link.STATIC.CONFIG.URL.SCODE = "SYS0037";
	...
	//----------------------------------------------------------------------------------------------------;
		...
		{
//			(function(){
//				//var type = SUtilLocation.getParameter__Name( "type" );
//				var host = window.b2link.url.getServerURL_WebServer_Self();
//				window.b2link.util.importHTML( host + "/ui_popup/Fancygrid/1.7.20/popup-55.html"
//					, "body"
//				);
//			})();
		...
		{
			//e;
			window.TtwLog.error( "index-batch.html Error : " + e );
			debugger;
		}
...
window[ "__INITIALIZE-PACKAGE__" ] = function( e, t )
{
	...
	window.setTimeout( function(){ if( window.__onload ) window.__onload() }, 200 );
};
