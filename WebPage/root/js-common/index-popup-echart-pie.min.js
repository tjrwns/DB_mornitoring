...
//----------------------------------------------------------------------------------------------------;
var fileNm = "js-common/index-popup-echart-pie.min.js";
...
//				"/ui/App/BatchDesktop/" + type
//				, host + "/ui/App/BatchDesktop/" + type + ".html"
//				, host + "/ui/App/BatchDesktop/" + type + ".js"
...
//	var host = window.b2link.url.getServerURL_WebServer_Self();
//
//	var uriParams = SUtilLocation.getObjectFromParamters();
//
//	alert(JSON.stringify(uriParams));
//	debugger;
...
//				window.b2link.util.importHTMLJS__And_Add_b2link_STATIC_UI(
//					"/ui/App/BatchDesktop/"
//					, host + "/ui/App/BatchDesktop/index-popup.html"
//					, host + "/ui/App/BatchDesktop/index-popup.js"
//					, window.b2link.ui.APPEND_CHILD_TARGET_ELEMENT_ID
//				);
//			})();
//
...
window[ "__INITIALIZE-PACKAGE__" ] = function( e, t )
{
	...
	//var params = SUtilLocation.getObjectFromParamters();

	var url = window.location.href;
	var reqUrl = decodeURI( window.location.href.split( "?url=" )[ 1 ] );

	SUtilXMLHttpReqGet.req_String( reqUrl, function( result ){
		var data;
		try{ data = JSON.parse( result ); } catch( er ){ window.TtwLog.error( "[ ERROR ] - " + er ); return; }

		var F0 = window.b2link.element.getElementByClassName;

		var target = F0( window.document, "test" );
		var loadSetting = {
			text : "loading"
			, effect : "spin"
		...
		myChart = window.opener.echarts.init( target );
