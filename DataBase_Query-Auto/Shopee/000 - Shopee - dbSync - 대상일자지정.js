...
//----------------------------------------------------------------------------------------------------;
var fileNm = "000 - Shopee - dbSync - 00";
...
FUNCTIONS.push(function(){
	...
	global.console.log( "[S] - Shopee - dbSync - 머지데이터" );
	...
	global.console.log( "[E] - Shopee - dbSync - 머지데이터" );
});
...
FUNCTIONS.push(function(){
	...
	global.console.log( "[S] - Shopee - dbSync - _STATISTICS--COMMON" );
	...
	global.console.log( "[E] - Shopee - dbSync - _STATISTICS--COMMON" );
});
...
FUNCTIONS.push(function(){
	...
	global.console.log( "[S] - Shopee - dbSync - Diff" );
	...
	//-------------------------;
	global.console.log( "[E] - Shopee - dbSync - Diff" );
});
