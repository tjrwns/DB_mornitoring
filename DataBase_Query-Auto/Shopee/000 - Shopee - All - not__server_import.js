...
//----------------------------------------------------------------------------------------------------;
var fileNm = "000 - Shopee - All - not__server_import";
...
var _SITE_NAME00_ = "SHOPEE";
var _DB_NAME_PREFIX00_ = "Shopee";
var _DB_NAME_PREFIX01_ = "shopee";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Shopee - 수집_데이터_병합--날짜지정.dbjs";
	global.console.log( "[ S ] - " + fileNm );
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Shopee - _STATISTICS--COMMON.dashboard-detail - 기간지정 - 재생성.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Shopee - _STATISTICS--COMMON.dashboard-daily - 기간지정 - 재생성.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Shopee - _STATISTICS--COMMON.dashboard-ERROR - 기간지정 - 재생성.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Shopee - makeDiffData -- 01_일자별생성.dbjs";
...
//	var importDb00 = _DB_NAME_PREFIX00_ + "_" + year + "_continuity";
...
//	try
//	{
//		CMD = _CMDS.CMD001.replace( "<!=HOST=!>", importHost00 )
...
FUNCTIONS.push(function(){
	...
	var exportHost00 = TARGET_DB_PORT[ 'SHOPEE' ].host;
	var exportPort00 = TARGET_DB_PORT[ 'SHOPEE' ].port;


	var exportDb00 = "Shopee_" + year;
	var exportCol00 = CONFIG.PARAMTERS_MONGODB_QUERY.TARGET_DATE;
	var exportDb01 = "Shopee_" + year + "-ERROR";
	var exportCol01 = CONFIG.PARAMTERS_MONGODB_QUERY.TARGET_DATE;
//	var exportDb02 = "SHOPEE_" + year;
