...
//----------------------------------------------------------------------------------------------------;
var fileNm = "000 - Shopee - dbSync - 대량실행파일만들기";
...
//----------------------------------------------------------------------------------------------------goods_list 임포트;
global.console.log( "[ S ] - Shopee - dbSync - Make BAT FILE" );
...
for(;i<iLen;++i){
	...
	var CMD00 = 'call "000 - Shopee - dbSync - excuter.bat" ' + io + '\n';
	CMDS += CMD00;
}
CMDS += "cmd/k";
SUtilFsWriteStream.writeFile( _CWD_ + "\\000 - Shopee - dbSync__" + startDate + "_" + endDate + ".bat", CMDS );

global.console.log( "[ E ] - Shopee - dbSync - Make BAT FILE" );
