...
var _SITE_NAME00_ = "KAOLA";
var _DB_NAME_PREFIX00_ = "Kaola";
var _DB_NAME_PREFIX01_ = "kaola";
...
//	, "VIP--Lite"            : { "shot" : "192.168.0.230", "port" : 55543 }
}
//*/
...
FUNCTIONS.push(function(){
	...
	var exportDb00 = "goods_list__" + _DB_NAME_PREFIX01_;
...
//----------------------------------------------------------------------------------------------------product_service_kaola 임포트;

FUNCTIONS.push(function(){

	global.console.log( "[ S ] - Kaola -product_service_kaola 임포트 " );
	...
	global.console.log( "[ E ] - Kaola -product_service_kaola 임포트 " );
});
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Kaola - 수집_데이터_병합--날짜지정.dbjs";
	global.console.log( "[ S ] - " + fileNm );
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Kaola - Kaola_201＊-N - 생성된 병합 데이터중에서 오류데이터 제거 - 카테고리아이디 - 기간지정.dbjs";
	global.console.log( "[ S ] - " + fileNm );
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Kaola - _STATISTICS--COMMON.dashboard-detail - 기간지정 - 재생성.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Kaola - _STATISTICS--COMMON.dashboard-daily - 기간지정 - 재생성.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Kaola - _STATISTICS--COMMON.dashboard-ERROR - 기간지정 - 재생성.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Kaola - makeDiffData -- 01_일자별생성.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Kaola - skumapper -- 02_매핑데이터작업 -- collected_data 생성.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Kaola - 데이터정제 -- graph_data -- daily_price -- 날짜지정.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Kaola - 데이터정제 -- graph_data -- monthly_price -- 년월지정.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Kaola - 데이터정제 -- graph_data -- weekly_price -- 년주차지정.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Kaola - Lite_Data - 생성.dbjs";
	global.console.log( "[ S ] - " + fileNm );
...
//----------------------------------------------------------------------------------------------------Kaola - Lite_Data - goods_list - 매핑;

FUNCTIONS.push(function(){

	var fileNm = "Kaola - Lite_Data - goods_list - 매핑.dbjs";
	global.console.log( "[ S ] - " + fileNm );
...
FUNCTIONS.push(function(){
	...
	var importHost00 = TARGET_DB_PORT[ 'KAOLA--Lite' ].host;
	var importPort00 = TARGET_DB_PORT[ 'KAOLA--Lite' ].port;
...
FUNCTIONS.push(function(){
	...
	var exportCol00 = CONFIG.PARAMTERS_MONGODB_QUERY.TARGET_DATE;
	var importDb00 = "collected_data_kaola";
...
FUNCTIONS.push(function(){
	...
	var exportCol01 = CONFIG.PARAMTERS_MONGODB_QUERY.TARGET_DATE;
	var exportDb02 = _DB_NAME_PREFIX00_ + "_" + year + "-N";
	var exportCol02 = CONFIG.PARAMTERS_MONGODB_QUERY.TARGET_DATE;
