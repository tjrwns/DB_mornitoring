...
//----------------------------------------------------------------------------------------------------;
var fileNm = "000 - Kaola - dbSync - 대상일자지정";
...
FUNCTIONS.push(function(){
	...
	global.console.log( "[S] - Kaola - dbSync - 머지데이터" );
	...
	global.console.log( "[E] - Kaola - dbSync - 머지데이터" );
});
...
FUNCTIONS.push(function(){
	...
	global.console.log( "[S] - Kaola - dbSync - _STATISTICS--COMMON" );
	...
	global.console.log( "[E] - Kaola - dbSync - _STATISTICS--COMMON" );
});
...
FUNCTIONS.push(function(){
	...
	global.console.log( "[S] - Kaola - dbSync - Diff" );
	...
	//-------------------------;
	global.console.log( "[E] - Kaola - dbSync - Diff" );
});
