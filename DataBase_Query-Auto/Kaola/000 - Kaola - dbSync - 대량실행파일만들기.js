...
//----------------------------------------------------------------------------------------------------;
var fileNm = "000 - Kaola - dbSync - 대량실행파일만들기";
...
//----------------------------------------------------------------------------------------------------goods_list 임포트;
global.console.log( "[ S ] - Kaola - dbSync - Make BAT FILE" );


var startDate = "20190620";
var endDate = "20190627";
...
for(;i<iLen;++i){
	...
	var CMD00 = 'call "000 - Kaola - dbSync - excuter.bat" ' + io + '\n';
	CMDS += CMD00;
}
CMDS += "cmd/k";
SUtilFsWriteStream.writeFile( _CWD_ + "\\000 - Kaola - dbSync__" + startDate + "_" + endDate + ".bat", CMDS );

global.console.log( "[ E ] - Kaola - dbSync - Make BAT FILE" );
