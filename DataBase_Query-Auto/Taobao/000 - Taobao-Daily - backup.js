...
//----------------------------------------------------------------------------------------------------;
var fileNm = "000 - Taobao-Daily - backup";
...
var _BACKUP_PATH00_ = "G:\\내 드라이브\\최석준\\업무\\B2LiNK-MongoDB-OnSight--Taobao-Daily - Data\\";
var _BACKUP_PATH01_ = "E:\\GitHub_B2LiNK\\B2LiNK-MongoDB-OnSight--Taobao-Daily - Data\\";

var _BACKUP_PATH_BY_DBNAME_ = {

	google : {
		  "Taobao_2018" : {"path" : _BACKUP_PATH00_ + "JSON - 머지\\2018\\", "isBackup" : 1}
		, "Taobao_2018-Lite" : {"path" : _BACKUP_PATH00_ + "JSON - Lite\\2018\\", isBackup : 1 }
		, "Taobao_2018-Lite--PIMS" : {"path" : _BACKUP_PATH00_ + "JSON - Lite - PIMS\\2018\\", isBackup : 1 }
		, "Taobao_2018--비교" : {"path" : _BACKUP_PATH00_ + "JSON - 비교\\2018\\", "isBackup" : 1}
		, "Taobao_2018-ERROR" : {"path" : _BACKUP_PATH00_ + "JSON - 머지 - ERROR\\2018\\", "isBackup" : 1}
		, "Taobao_2019" : {"path" : _BACKUP_PATH00_ + "JSON - 머지\\2019\\", "isBackup" : 1}
		, "Taobao_2019-Lite" : {"path" : _BACKUP_PATH00_ + "JSON - Lite\\2019\\", isBackup : 1 }
		, "Taobao_2019-Lite--PIMS" : {"path" : _BACKUP_PATH00_ + "JSON - Lite - PIMS\\2019\\", isBackup : 1 }
		, "Taobao_2019--비교" : {"path" : _BACKUP_PATH00_ + "JSON - 비교\\2019\\", "isBackup" : 1}
		, "Taobao_2019-ERROR" : {"path" : _BACKUP_PATH00_ + "JSON - 머지 - ERROR\\2019\\", "isBackup" : 1}
	//	, "_STATISTICS--COMMON" : {"path" : _BACKUP_PATH00_ + "JSON - 머지\\2018\\", "isBackup" : 1}
	//	, "daily_master" : {"path" : _BACKUP_PATH00_ + "JSON - 머지\\2018\\", "isBackup" : 1}
	//	, "daily_master_h5" : {"path" : _BACKUP_PATH00_ + "JSON - 머지\\2018\\", "isBackup" : 1}
	...
	//	, "graph_data" : {"path" : _BACKUP_PATH00_ + "JSON - 머지\\2018\\", "isBackup" : 1}
	//	, "product" : {"path" : _BACKUP_PATH00_ + "JSON - 머지\\2018\\", "isBackup" : 1}
	}
	, local : {
		"Taobao_2018" : {"path" : _BACKUP_PATH01_ + "JSON - 머지\\2018\\", "isBackup" : 1}
		, "Taobao_2018-Lite" : {"path" : _BACKUP_PATH00_ + "JSON - Lite\\2018\\", isBackup : 1 }
		, "Taobao_2018-Lite--PIMS" : {"path" : _BACKUP_PATH00_ + "JSON - Lite - PIMS\\2018\\", isBackup : 1 }
		, "Taobao_2018--비교" : {"path" : _BACKUP_PATH01_ + "JSON - 비교\\2018\\", "isBackup" : 1}
		, "Taobao_2018-ERROR" : {"path" : _BACKUP_PATH01_ + "JSON - 머지 - ERROR\\2018\\", "isBackup" : 1}
		, "Taobao_2019" : {"path" : _BACKUP_PATH01_ + "JSON - 머지\\2019\\", "isBackup" : 1}
		, "Taobao_2019-Lite" : {"path" : _BACKUP_PATH00_ + "JSON - Lite\\2019\\", isBackup : 1 }
		, "Taobao_2019-Lite--PIMS" : {"path" : _BACKUP_PATH00_ + "JSON - Lite - PIMS\\2019\\", isBackup : 1 }
		, "Taobao_2019--비교" : {"path" : _BACKUP_PATH01_ + "JSON - 비교\\2019\\", "isBackup" : 1}
		, "Taobao_2019-ERROR" : {"path" : _BACKUP_PATH01_ + "JSON - 머지 - ERROR\\2019\\", "isBackup" : 1}
	//	, "_STATISTICS--COMMON" : {"path" : _BACKUP_PATH01_ + "JSON - 머지\\2018\\", "isBackup" : 1}
	//	, "daily_master" : {"path" : _BACKUP_PATH01_ + "JSON - 머지\\2018\\", "isBackup" : 1}
	//	, "daily_master_h5" : {"path" : _BACKUP_PATH01_ + "JSON - 머지\\2018\\", "isBackup" : 1}
