...
//----------------------------------------------------------------------------------------------------;
var fileNm = "000 - Taobao-Daily - dbSync - 00";
...
FUNCTIONS.push(function(){
	...
	global.console.log( "[S] - Taobao-Daily - dbSync - 머지데이터" );
	...
	global.console.log( "[E] - Taobao-Daily - dbSync - 머지데이터" );
});
...
FUNCTIONS.push(function(){
	...
	global.console.log( "[S] - Taobao-Daily - dbSync - _STATISTICS--COMMON" );
	...
	global.console.log( "[E] - Taobao-Daily - dbSync - _STATISTICS--COMMON" );
});
...
FUNCTIONS.push(function(){
	...
	global.console.log( "[S] - Taobao-Daily - dbSync - Diff" );
	...
	//-------------------------;
	global.console.log( "[E] - Taobao-Daily - dbSync - Diff" );
});
