...
//----------------------------------------------------------------------------------------------------;
var fileNm = "000 - Taobao-Daily - dbSync - 대량실행파일만들기";
...
//----------------------------------------------------------------------------------------------------goods_list 임포트;
global.console.log( "[ S ] - Taobao-Daily - dbSync - Make BAT FILE" );


var startDate = "20190612";
...
for(;i<iLen;++i){
	...
	var CMD00 = 'call "000 - Taobao-Daily - dbSync - excuter.bat" ' + io + '\n';
	CMDS += CMD00;
}
CMDS += "cmd/k";
SUtilFsWriteStream.writeFile( _CWD_ + "\\000 - Taobao-Daily - dbSync__" + startDate + "_" + endDate + ".bat", CMDS );

global.console.log( "[ E ] - Taobao-Daily - dbSync - Make BAT FILE" );
