...
FUNCTIONS.push(function(){
	...
	var year = CONFIG.PARAMETERS_NODEJS.CHILDPROCESS_PARAMETER.TARGET_WEEK_NO.substr( 0, 4 );
	var weekNo = CONFIG.PARAMETERS_NODEJS.CHILDPROCESS_PARAMETER.TARGET_WEEK_NO.substr( 4, 2 ) * 1;
