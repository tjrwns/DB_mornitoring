...
//----------------------------------------------------------------------------------------------------;
var fileNm = "000 - Taobao-Daily - All - monthly - data";
...
FUNCTIONS.push(function(){
	...
	var year = Number( CONFIG.PARAMETERS_NODEJS.CHILDPROCESS_PARAMETER.TARGET_MONTH.substr( 0, 4 ) );
	var month = Number( CONFIG.PARAMETERS_NODEJS.CHILDPROCESS_PARAMETER.TARGET_MONTH.substr( 4, 2 ) );
	...
	var exportCol00 = "monthly_brand_pricelist_per_PIMS";
	var exportCol01 = "monthly_brand_salesamount_by_channel";
	var exportCol02 = "monthly_brand_top3PIMS_by_shop";
	var exportCol03 = "monthly_brand_top5_shop";

	var importDb00 = "graph_data";
	var importDb01 = "graph_data";
	var importDb02 = "graph_data";

	var importCol00 = "monthly_brand_pricelist_per_PIMS";
	var importCol01 = "monthly_brand_salesamount_by_channel";
	var importCol02 = "monthly_brand_top3PIMS_by_shop";
	var importCol03 = "monthly_brand_top5_shop";
	...
	var QUERY00 = "{ year : " + year + ", month : " + month + " }"
