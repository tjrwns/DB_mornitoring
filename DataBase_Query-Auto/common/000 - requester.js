...
//굿즈리스트를생성하는 라우터;
URLS.URL00 = "http://localhost:45528/common/dashboard/getERRORInfoToYearByShop?code_db=SHOPEE&targetYear=2019";
...
var uris = {
	common : {
		dashboard : {
			getDailyInfoToYearByShop	: [ "code_db", "targetYear", "nm_site" ]
			, getDetailByShop			: [ "code_db", "targetYear", "nm_site" ]
			, getDiffInfoByShop			: [ "code_db", "targetYear", "nm_site" ]
			, getERRORInfoToYearByShop	: [ "code_db", "targetYear", "nm_site" ]
		}
	}
};

var site_info = {
	  "TAOBAO-DAILY" : { code_db : "TAOBAO-DAILY"	, nm_site : "Taobao" }
	, "KAOLA"		 : { code_db : "KAOLA"			, nm_site : "Kaola" }
	, "VIP"			 : { code_db : "VIP"			, nm_site : "VIP" }
	, "LAZADA"		 : { code_db : "LAZADA"			, nm_site : "Lazada" }
	, "SHOPEE"		 : { code_db : "SHOPEE"			, nm_site : "Shopee" }
}

/*
http://localhost:45528/common/dashboard/getDailyInfoToYearByShop	?code_db=TAOBAO-DAILY&	targetYear=2019
http://localhost:45528/common/dashboard/getDetailByShop				?code_db=TAOBAO-DAILY&						nm_site=%3C!=NM_SITE=!%3E
http://localhost:45528/common/dashboard/getDiffInfoByShop			?code_db=TAOBAO-DAILY&	target_year=2019	nm_site=Taobao
http://localhost:45528/common/dashboard/getERRORInfoToYearByShop	?code_db=TAOBAO-DAILY&	targetYear=2019
*/
//URL을 생성하는 로직;
(function(){
