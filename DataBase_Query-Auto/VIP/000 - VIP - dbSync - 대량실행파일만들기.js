...
//----------------------------------------------------------------------------------------------------;
var fileNm = "000 - VIP - dbSync - 대량실행파일만들기";
...
//----------------------------------------------------------------------------------------------------goods_list 임포트;
global.console.log( "[ S ] - VIP - dbSync - Make BAT FILE" );


var startDate = "20190627";
var endDate = "20190631";
...
for(;i<iLen;++i){
	...
	var CMD00 = 'call "000 - VIP - dbSync - excuter.bat" ' + io + '\n';
	CMDS += CMD00;
}
CMDS += "cmd/k";
SUtilFsWriteStream.writeFile( _CWD_ + "\\000 - VIP - dbSync__" + startDate + "_" + endDate + ".bat", CMDS );

global.console.log( "[ E ] - VIP - dbSync - Make BAT FILE" );
