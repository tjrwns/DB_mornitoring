...
//----------------------------------------------------------------------------------------------------;
var fileNm = "000 - Lazada - All - not__server_import";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Lazada - 수집_데이터_병합--날짜지정.dbjs";
	global.console.log( "[ S ] - " + fileNm );
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Lazada - _STATISTICS--COMMON.dashboard-detail - 기간지정 - 재생성.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Lazada - _STATISTICS--COMMON.dashboard-daily - 기간지정 - 재생성.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Lazada - _STATISTICS--COMMON.dashboard-ERROR - 기간지정 - 재생성.dbjs";
...
FUNCTIONS.push(function(){
	...
	var fileNm = "Lazada - makeDiffData -- 01_일자별생성.dbjs";
