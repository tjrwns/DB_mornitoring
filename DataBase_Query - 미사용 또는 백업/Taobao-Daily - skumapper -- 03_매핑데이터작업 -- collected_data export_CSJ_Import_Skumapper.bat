SET excuteFile="Kaola - skumapper -- 03_매핑데이터작업 -- collected_data export_CSJ_Import_Skumapper.bat"
...
set exportDb0=Taobao_%year%-collected_data
set exportCol0=%date%
set outFile0=%_EXPORT_PATH_%%exportDb0%.%exportCol0%.json

::IMPORT
set importDb0=collected_data_taobao
set importCol0=taobao_%date%
