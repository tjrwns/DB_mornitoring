...
call ..\..\Development-Binary-Windows\Binary\MongoDB\4.0.0\mongoimport --host 192.168.1.2 --port 55528 --username b2link --password qlxnfldzmdb2017_ --authenticationDatabase=admin --db %importDb0% --collection "%importCol0%" --file "%outFile0%" --mode insert --numInsertionWorkers 1 --jsonArray
